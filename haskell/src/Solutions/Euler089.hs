...
minimumForm n
    ...
    | n >= 900 = "CM" ++ minimumForm (n - 900)
    | n >= 500 = "D" ++ minimumForm (n - 500)
    | n >= 400 = "CD" ++ minimumForm (n - 400)
    | n >= 100 = "C" ++ minimumForm (n - 100)
    | n >= 90 = "XC" ++ minimumForm (n - 90)
    | n >= 50 = "L" ++ minimumForm (n - 50)
    | n >= 40 = "XL" ++ minimumForm (n - 40)
    | n >= 10 = "X" ++ minimumForm (n - 10)
    | otherwise = ["", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX"] !! n
